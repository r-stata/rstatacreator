#' @title create_titlepic: 创建白底风格的标题图
...
#' @import magick
#' @export
create_titlepic <- function(img = "https://mdniceczx.oss-cn-beijing.aliyuncs.com/20230421232743.png", title = "推文标题", output_file = paste0("titlepic_", basename(img)), addwm = F) {
