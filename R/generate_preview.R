...
#' @export
generate_preview <- function(dir, addwm = F) {
  ...
  # 拷贝到目标文件夹
  file.copy("wechat_title.png", paste0(dir, "/Preview/wechat_title.png"))
  file.copy("duanshu_title.png", paste0(dir, "/Preview/duanshu_title.png"))
...
")) -> py
    ...
    create_tablepre(mydata, title = tools::file_path_sans_ext(basename(datapath)),
              data_source = lst$`data-source`, decimal_places = 0,
